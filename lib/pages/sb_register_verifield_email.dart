...
class SbRegisterVerifyEmail extends StatefulWidget {
  const SbRegisterVerifyEmail({super.key});

  @override
  State<SbRegisterVerifyEmail> createState() => SbRegisterVerifyEmailState();
}

class SbRegisterVerifyEmailState extends State<SbRegisterVerifyEmail> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10,),
              Text(
                'Congratulazione ti sei registrato con successo, ti è stata inviata un\'email di verifica !',
                style: TextStyle(
                      ...
                      child: SbButtonMaincolor(
                        ...
                        function: () async{
                          ...
                          if(_formKey.currentState!.validate()){
                            dynamic data = await ApiUser().verifyEmail(emailController.text);
